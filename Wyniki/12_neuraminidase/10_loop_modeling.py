...
for i in range(0,10): 
    ...
    ft.add_edge(70,76,1)
    ft.add_edge(76,73,-1)
    ft.add_edge(76,230,-1)
    ft.add_edge(230,232,-1)
    ft.add_edge(230,236,2)
    ft.add_edge(236,233,-1)
    ft.add_edge(236,391,-1)
    ...
    kic_mover.set_pivots(72,73,74)
    kic_mover.set_pivots(232,233,274)
    kic_mover.apply(p)
